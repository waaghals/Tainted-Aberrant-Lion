...
1.	Laad de homepage http://localhost/Management/CreateUser/
    - [x] Er is een genereer scherm zichtbaar
2.  Vul in beide velden in: `test@toip.nl`
3.  Klik op de knop `Create Access Code`
	- [x] In het scherm komt een melding met de tekst: `Created access code succesfully`.
...
3.  Klik op de knop `Create Access Code`
	- [x] In het scherm komt een melding met de tekst: `E-Mail fiels do not match.`.
3.  Maak een van de twee velden leeg en klik op de knop `Create Access Code`
	- [x] In het scherm komt een melding met de tekst: `Not everything is filled in`.
