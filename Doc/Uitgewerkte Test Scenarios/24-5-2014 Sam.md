...
2. Vergroot en verklein het scherm
    ...
    - [x] Bij kleine schermen (zoals voor telefoons) komen meerdere rijen tekst onder elkaar te staan.
...
1.  Laad de homepage http://localhost/Management/ChangePassword
    - [x] Er is een overzicht zichtbaar om je wachtwoord aan te passen
...
3.      Druk op de "Reset" knop in de menubalk.
    ...
    - [x] Alle filter opties worden leeggemaakt.
