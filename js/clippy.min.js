...
clippy.Agent = function(a, b, c) {
    this.path = a, this._queue = new clippy.Queue($.proxy(this._onQueueEmpty, this)), this._el = $('<div class="clippy"></div>').hide(), $(document.body).append(this._el), this._animator = new clippy.Animator(this._el, a, b, c), this._balloon = new clippy.Balloon(this._el), this._setupEvents()
}, clippy.Agent.prototype = {gestureAt: function(a, b) {
        ...
        c === undefined && (c = 1e3), this._addToQueue(function(d) {
            ...
            var f = $.proxy(function(e, f) {
                f === clippy.Animator.States.EXITED && d(), f === clippy.Animator.States.WAITING && this._el.animate({top: b, left: a}, c, $.proxy(function() {
        ...
        if (this._el.css("top") === "auto" || !this._el.css("left") === "auto") {
            var b = $(window).width() * .8, c = ($(window).height() + $(document).scrollTop()) * .8;
        ...
        a = a || 500, this._addToQueue(function(b) {
        ...
        h - j < 0 ? h = j : h + b + j > e && (h = e - b - j), i - j < 0 ? i = j : i + c + j > d && (i = d - c - j), this._el.css({left: i, top: h}), this._balloon.reposition()
        ...
        this._el.css({top: this._targetY, left: this._taregtX}), this._dragUpdateLoop = window.setTimeout($.proxy(this._updateLocation, this), 10)
    ...
    for (var f = 1; f < this._data.overlayCount; f++) {
...
}, clippy.Animator.prototype = {_setupElement: function(a) {
        var b = this._data.framesize;
        return a.css("display", "none"), a.css({width: b[0], height: b[1]}), a.css("background", "url('" + this._path + "/map.png') no-repeat"), a
    }, animations: function() {
        ...
        this._step()
    }}, clippy.Animator.States = {WAITING: 1, EXITED: 0}, clippy.Balloon = function(a) {
    this._targetEl = a, this._hidden = !0, this._setup()
}, clippy.Balloon.prototype = {WORD_SPEAK_TIME: 250, CLOSE_BALLOON_DELAY: 2e3, _setup: function() {
    ...
    }, _BALLOON_MARGIN: 15, _position: function(a) {
        ...
        this._balloon.css({top: h, left: g}), this._balloon.addClass("clippy-" + a)
    }, _isOut: function() {
...
}, clippy.Queue.prototype = {queue: function(a) {
